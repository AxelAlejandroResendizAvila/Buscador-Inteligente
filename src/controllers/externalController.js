...
const buscarProductos = async (request, response) => {
    ...
    // Validación: Si no se envía el parámetro q, devolver error 400
    if (!q || q.trim() === '') {
    ...
    try {
        // Búsqueda con ILIKE en nombre y descripción (Case Insensitive)
        // Uso de consultas parametrizadas ($1) para prevenir SQL Injection
        const query = `
